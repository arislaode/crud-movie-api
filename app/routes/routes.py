...
from app.controller.movie import read_by_id, read_movie
from app.controller.movie import read_by_id
...
app.add_url_rule(rule="/v1/read", view_func=read_movie, methods=["POST"])
